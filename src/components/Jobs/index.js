...
class Jobs extends Component {
  state = {
    ...
    activeSalaryRangeId: '', // initial value for salary range ID
    employmentTypesChecked: [], // initial value for employment types
  }

  componentDidMount() {
    this.getProfileDetails()
    this.getJobs() // Call getJobs when the component mounts
  }
  ...
  getJobs = async () => {
    ...
    // Form the query parameters using the state values
      ...
      <div className='jobs-page-container'>
        ...
        <div className='jobs-page'>
          ...
          <div className='jobs-container'>
            ...
            {/* Paragraph displaying the short bio */}
            {profileDetails.shortBio && (
              <p className='short-bio-paragraph'>{profileDetails.shortBio}</p>
            )}
          </div>
        </div>
      </div>
